...
if (isset($_POST['name'])) {
    ...
    if (isset($_POST['idCategories'])) {
        ...
        $categori = new Book();
        $insert = $categori->insert($name, $id);
    ...
    <div class="wrap-contact100">
        <form class="contact100-form validate-form" method="post">
            ...
            <div class="wrap-input100 validate-input" data-validate="Name is required">
                ...
                <span class="label-input100">Your Id Categories</span>
                <input class="input100" type="text" name="idCategories" placeholder="Id Categories">
